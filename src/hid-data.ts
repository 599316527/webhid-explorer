...
const usagePageName = (usagePage: number): string => {
  const kUsagePageNames: Record<number, string> = {
    // 0x0000 is Undefined
...
export const usageName = (usage: number): string => {
  const kUsageNames: Record<number, string> = {
    // Generic Desktop
    0x00010001: 'Pointer',
    0x00010002: 'Mouse',
    0x00010004: 'Joystick',
